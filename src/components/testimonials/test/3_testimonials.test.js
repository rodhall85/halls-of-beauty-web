...
describe('three testimonials', () => { 
  ...
  describe('testimonial data', () => {
    ...
    it('should create testimonials with correct data for location', () => {
      ...
      expect(texts).toEqual(['first_location', 'second_location', 'third_location']);
    });
    ...
    it('should create testimonials with correct data for message', () => {
      ...
      expect(texts).toEqual(['first_message', 'second_message', 'third_message']);
    });
